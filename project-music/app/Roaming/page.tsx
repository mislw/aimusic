...
import { trendingStore } from '@/app/data' ;
...
const [selectedPage, setSelectedPage] = useState('All');
  ...
  return (
    <div className="flex flex-col">
      <div className='mt-6 font-bold ml-4'><a href="/">Home {'>'} </a>Roaming </div>
      <div className="flex mt-12 ml-10 text-3xl font-bold">Roaming </div>
